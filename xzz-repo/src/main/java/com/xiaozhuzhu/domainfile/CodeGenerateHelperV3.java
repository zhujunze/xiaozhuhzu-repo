...
@AllArgsConstructor
public class CodeGenerateHelperV3 {
    ...
    public CodeGenerateHelperV3(DataSource dataSource) {
        this.jdbcTemplate = new JdbcTemplate(dataSource);
    }

    public CodeGenerateHelperV3(DataSource dataSource, Boolean removePrefix) {
        this.jdbcTemplate = new JdbcTemplate(dataSource);
...
//                "\tprivate NamedParameterJdbcTemplate namedParameterJdbcTemplate;\n\n\n" +
    ...
    private String generateEntityContent(String tableName) {
        ...
        for (TableField field : fields) {
            ...
            fieldContent.append("\t@Schema(description = \"").append(comment).append("\")\n")
        ...
        typeContent.append("import io.swagger.v3.oas.annotations.media.Schema;\n")
